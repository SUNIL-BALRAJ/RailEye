...
class Camera(models.Model):
    hotspot = models.ForeignKey(User, null=True, blank=True, on_delete=models.CASCADE,related_name="camera_hotspot")
    user = models.ForeignKey(User, null=True, blank=True, on_delete=models.CASCADE,related_name="camera_user")
    name = models.CharField(max_length=120, unique=True)
    place = models.CharField(max_length=120)
    def __str__(self):
        return str(self.id)
...
class Video(models.Model):
    ...
    name = models.CharField(max_length=120, unique=True)
    video  = models.FileField(upload_to="static/assets/images/video/", null=True, blank=True)
    cropped_video = models.FileField(upload_to="static/assets/images/cropped_video/", null=True, blank=True)
...
class Suspect(models.Model): 
    ...
    image = models.ImageField(upload_to="static/assets/images/img/",null=True,blank=True)
    ...
    query_img = models.ImageField(upload_to="static/assets/images/img/",null=True,blank=True)
